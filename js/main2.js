...
function createLights() {
  ...
  shadowLight.position.set(0, 0, 200);
...
function createFloor(){
  floor = new THREE.Mesh(new THREE.PlaneBufferGeometry(10000,50000), new THREE.MeshBasicMaterial({color: 0xebe5e7}));
...
Fish= function(){
  ...
  var bodyGeom = new THREE.BoxGeometry(30,140, 30, 4);
  ...
  mustacheGeom.applyMatrix( new THREE.Matrix4().makeTranslation( 20, 0, 0 ) );
